...
require_once './baglanti/qoshul.php';

$parametr_Sorgu = $db->prepare("SELECT * FROM parametrler WHERE parametr_id = :id");
$parametr_Sorgu->execute([
    'id' => 0
]);
$parametr_Cavab=$parametr_Sorgu->fetch(PDO::FETCH_ASSOC);



$kompanya_Sorgu = $db->prepare("SELECT * FROM kompanyalar WHERE kompanya_id = :id");
$kompanya_Sorgu->execute([
    'id' => 1
]);
$kompanya_Cavab=$kompanya_Sorgu->fetch(PDO::FETCH_ASSOC);
?>
...
<!DOCTYPE html>
 ...
 <head>
     ...
     <title><?php echo $parametr_Cavab['parametr_vebSaytinAdi']?> - Virtual Mağazanız</title>
     <meta name="keywords" content="<?php echo $parametr_Cavab['parametr_acharSozler'] ?>" />
     <meta name="description" content="<?php echo $parametr_Cavab['parametr_achiqlama'] ?>">
     <meta name="author" content="<?php echo $parametr_Cavab['parametr_muellif'] ?>">
     
    <!-- site Favicon -->
    <link rel="icon" href="./admin/<?php echo $parametr_Cavab['parametr_logo'] ?>" sizes="32x32" />
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-left header-top-left d-none d-lg-block">
                        <div class="header-top-social">
                            <span class="social-text text-upper">Bizi izləyin:</span>
                            <ul class="mb-0">
                                <li class="list-inline-item"><a class="hdr-facebook" href="<?php echo $parametr_Cavab['parametr_facebook'] ?>"><i class="ecicon eci-facebook"></i></a></li>
                                <li class="list-inline-item"><a class="hdr-instagram" href="<?php echo $parametr_Cavab['parametr_instagram'] ?>"><i class="ecicon eci-instagram"></i></a></li>
                                <li class="list-inline-item"><a class="hdr-linkedin" href="<?php echo $parametr_Cavab['parametr_linkedin'] ?>"><i class="ecicon eci-linkedin"></i></a></li>
                                <li class="list-inline-item"><a class="hdr-instagram" href="<?php echo $parametr_Cavab['parametr_youtube'] ?>"><i class="ecicon eci-youtube"></i></a></li>
                                <li class="list-inline-item"><a class="hdr-facebook" href="<?php echo $parametr_Cavab['parametr_google'] ?>"><i class="ecicon eci-google"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col text-center header-top-center">
                        <div class="header-top-message text-upper">
                            <span><?php echo $kompanya_Cavab['kompanya_muddet'] ?> gün müddətində hər <?php echo $kompanya_Cavab['kompanya_qiymet'] ?> <?php echo $kompanya_Cavab['kompanya_valyuta'] ?> sifarişə çatdırılma Pulsuz!</span>
                        </div>
                    </div>



                    <?php include './languageAndCurrency.php' ?>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.php"><img src="./admin/<?php echo $parametr_Cavab['parametr_logo'] ?>" alt="Site Logo" /><img
                                        class="dark-logo" src="./admin/<?php echo $parametr_Cavab['parametr_logo_Achiq'] ?>" alt="Site Logo"
                        ...
                        <div class="align-self-center">
                            <div class="header-search">
                                <form class="ec-btn-group-form" action="#">
                                    <input class="form-control" placeholder="Məhsulun adını yazın..." type="text">
                    ...
                    <div class="col-md-12 align-self-center">
                        <div class="ec-main-menu">
                            <ul>
                                ...
                                <li class="dropdown position-static"><a href="javascript:void(0)">Kateqoriyalar</a>
                                ...
                                <li class="dropdown"><a href="javascript:void(0)">Məhsullar</a>
                                    <ul class="sub-menu">
