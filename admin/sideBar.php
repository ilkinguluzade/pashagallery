<ul class="menu">
                        ...
                        <li class="menu-title">Super Admin - MENU</li>
                        <li class="menu-item">
                            <a href="#menuEcommerce" data-bs-toggle="collapse" class="menu-link">
                                <span class="menu-icon"><i data-feather="settings"></i></span>
                                <span class="menu-text"> Parametrlər </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="menuEcommerce">
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a href="webSettings.php" class="menu-link">
                                            <span class="menu-text">Veb Parametrləri</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="contactSettings.php" class="menu-link">
                                            <span class="menu-text">Əlaqə Parametrləri</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="socialSettings.php" class="menu-link">
                                            <span class="menu-text">Sosial Şəbəkə Parametrləri</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="apiSettings.php" class="menu-link">
                                            <span class="menu-text">APİ Parametrləri</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="smtpSettings.php" class="menu-link">
                                            <span class="menu-text">SMTP Parametrləri</span>
                                        </a>
                                    </li>
